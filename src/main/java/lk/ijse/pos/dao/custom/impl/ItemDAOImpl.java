...
public class ItemDAOImpl implements ItemDAO {
    ...
    public boolean save(final Item entity) throws SQLException {
        try {
            String SAVE_ITEM = "INSERT INTO item (id, description, qty, price) VALUES (?,?,?,?)";
    ...
    public boolean delete(final int id) throws SQLException {
        try {
            String DELETE_CUSTOMER = "DELETE FROM item WHERE id=?";
    ...
    public boolean update(final Item entity) throws SQLException {
        try {
            String UPDATE_ITEM = "UPDATE item SET description=?, qty=?, price=? WHERE id=?";
    ...
    public Item getData(final int id) throws SQLException {
        try {
            String GET_CUSTOMER = "SELECT * FROM item WHERE id=?";
    ...
    public List<Item> getAll() throws SQLException {
        try {
            String FIND_ALL = "SELECT * FROM item";
